...
public class Grafo_ArregloDFS {
    ...
    public static void DFS(Grafo g,String desde, String hacia){
        ...
        Stack<String> nodo = new Stack<>();
        nodo.push(desde);
            
        while((nodo.isEmpty() != true) && (encontrado == false)){
            System.out.println(nodo);
            String vertice = nodo.pop();
    ...
    public static void push_adyacent_edges(Stack<String> s, Grafo g, String vertice){
